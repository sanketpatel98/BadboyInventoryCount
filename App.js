...
import AuditScannerScreen from "./components/Audit/AuditScannerScreen";
      ...
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Home">
          ...
          <Stack.Screen
            ...
            options={{ title: "Scanned Items List" }}
          />
          ...
          <Stack.Screen
            name="AuditScanner"
            component={AuditScannerScreen}
            options={{ title: "Audit Scanner" }}
          />
        </Stack.Navigator>
      </NavigationContainer>
    </Provider>
